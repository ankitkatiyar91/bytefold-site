---
layout: post
title: Convert Amount In Words
date: 2012-11-07 23:12:00.000000000 +05:30
type: post
parent_id: '0'
published: true
password: ''
...
meta:
  ...
  blogger_permalink: "/2012/11/convert-amount-in-words.html"
  blogger_internal: "/feeds/2635046121517897773/posts/default/4530341503015215463"
  _edit_last: '1'
...
public class AmountInWords {
	...
	private void input() {
		...
		try {
			System.out.print("Enter Amount to Convert in Words : ");
			num = in.nextInt();
		} catch (Exception e) {
			System.out.println("Number Less than 1 Arab(1000000000) Only Possible.");
			System.exit(1);
		}
